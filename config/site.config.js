...
module.exports = {
  ...
  title: "OneDrive - minhhungtsbd.me",
  ...
  footer:
    'Powered by <a href="minhhungtsbd.me" target="_blank" rel="noopener noreferrer">onedrive-index</a>. Made with ❤ by minhhungtsbd.me.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/minhhungtsbd'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:admin@minhhungtsbd.me',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/minhhungtsbd',
    },
  ],
